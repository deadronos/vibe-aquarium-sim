...
**Behavior:**
- **Prey (Fish):** Update `BoidsSystem` to include a "Flee" behavior. Fish will apply a strong steering force *away* from any entity tagged `isPredator` within a certain radius.
