  ...
  return (
    <group>
      ...
      <RigidBody type="fixed" position={[0, 0, -depth/2 - thickness/2]}>
            ...
            <MeshTransmissionMaterial color="#aaddff" samples={8} resolution={1024} thickness={0.5} roughness={0} chromaticAberration={0.02} anisotropy={0.1} ior={1.1} toneMapped={true} side={BackSide} />
         </Box>
      </RigidBody>
