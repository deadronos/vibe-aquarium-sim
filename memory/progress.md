...
- **Validation:** Focused trajectory tests pass (8 tests); the scheduler/system regression suite passes (14 tests); full format/lint/application-and-scoped-typecheck/test/build/bundle/smoke validation is green with 205 tests passed and 1 skipped.
