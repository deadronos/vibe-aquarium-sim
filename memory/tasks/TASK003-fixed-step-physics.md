...
| --- | --------------------------------------------- | ----------- | ---------- | ---------------- |
| 0.1 | Add `boidsFixedTick` runtime toggle + probe    | Not Started | 2025-12-09 | Experiment phase |
| 1.1 | Implement fixed-step scheduler service        | Not Started | 2025-12-09 | Configurable TBD |
| 1.2 | Move `BoidsSystem` into scheduler loop        | Not Started | 2025-12-09 | Force clamping   |
...
| 3.2 | Runtime toggles + debug overlays               | Not Started | 2025-12-09 | Tooling for testing |
| 4.1 | Add deterministic/integration tests           | Not Started | 2025-12-09 | Vitest-based     |
